...
sectors_df = pd.read_csv(snakemake.input.exio3_sectors_config[0], index_col=0, decimal=".")
aggregation_master_df = pd.read_excel(
    snakemake.input.aggregation_master[0], sheet_name=0, index_col="Exiobase3 full sectors"
)
res = (
